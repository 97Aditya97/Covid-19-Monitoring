...
public class GetAllDetails extends Activity {
    ListView lst1;
    String heartrate[];
    String personname[];
    String oxylevel[];
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.getalldetails);
        ...
        try{
            ...
            Toast.makeText(GetAllDetails.this, ""+e, Toast.LENGTH_LONG).show();
        }
    ...
    private class GetData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(GetAllDetails.this, null,"Searching Information...");
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                Toast.makeText(GetAllDetails.this," "+out, Toast.LENGTH_LONG).show();
                ...
                for (int i = 0; i < jsonMainNode.length(); i++) {
                    ...
                    heartrate[i] ="HeartRate : "+jsonChildNode.optString("HeartRate")+" OxyLevel : "+jsonChildNode.optString("Oxygen")+" Temp:"+jsonChildNode.optString("Oxygen");

                    Toast.makeText(GetAllDetails.this," "+personname[i], Toast.LENGTH_LONG).show();
                    //oxylevel[i]=jsonChildNode.optString("Oxygen");

                }


                LevelAdapter2 adapter=new LevelAdapter2(GetAllDetails.this,  personname,contact,heartrate);
