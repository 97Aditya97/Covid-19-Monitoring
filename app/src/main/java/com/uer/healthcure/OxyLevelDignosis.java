...
public class OxyLevelDignosis extends Activity {
    ListView lst1;
    String heartrate[];
    String personname[];
    String oxylevel[];
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oxyleveldignosis);
        ...
        try{
            ...
            Toast.makeText(OxyLevelDignosis.this, ""+e, Toast.LENGTH_LONG).show();
        }
    ...
    private class GetData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(OxyLevelDignosis.this, null,"Searching Information...");
        ...
        protected void onPostExecute(String result) {
            ...
            try{
               // Toast.makeText(OxyLevelDignosis.this," "+out, Toast.LENGTH_LONG).show();
                ...
                for (int i = 0; i < jsonMainNode.length(); i++) {
                    ...
                    heartrate[i]=jsonChildNode.optString("Oxygen");
                   int heartrat11= (int)Float.parseFloat(heartrate[i]);

                    if(heartrat11<90 || heartrat11>100 ) {
                        personname[i] = "Name : "+jsonChildNode.optString("Oxygen")+" OxyLevel : "+heartrate[i];
                    }
                ...
                LevelAdapter adapter=new LevelAdapter(OxyLevelDignosis.this,  personname);
                lst1.setAdapter(adapter)	;

            }catch(Exception e){
                Toast.makeText(OxyLevelDignosis.this," ", Toast.LENGTH_LONG).show();
            }
