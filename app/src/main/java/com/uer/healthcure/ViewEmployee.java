...
public class ViewEmployee extends Activity {
        ...
        try{
            ...
            lst1.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent show_i1= new Intent(ViewEmployee.this,ViewHealthDetails.class);
            ...
            Toast.makeText(ViewEmployee.this, ""+e, Toast.LENGTH_LONG).show();
        }
    ...
    private class GetData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            progress = ProgressDialog.show(ViewEmployee.this, null,"Searching Information...");
        ...
        protected void onPostExecute(String result) {
            ...
            try{
               // Toast.makeText(ViewEmployee.this," "+out, Toast.LENGTH_LONG).show();
                ...
                for (int i = 0; i < jsonMainNode.length(); i++) {
                    ...
                    userid[i]=jsonChildNode.optString("kitno");
                    name[i]=jsonChildNode.optString("Name");

                }
                LevelAdapter adapter=new LevelAdapter(ViewEmployee.this, name);
                lst1.setAdapter(adapter)	;

            }catch(Exception e){
                Toast.makeText(ViewEmployee.this," ", Toast.LENGTH_LONG).show();
            }
